...
Cl_Uint8Type Cl_ConsoleTxMsg[10];

Cl_Uint8Type testCl_BoolType = false;
...
extern Cl_ReturnCodes   Cl_SendDatatoconsoleDummycommand(Cl_ConsoleTxCommandtype,Cl_Uint8Type*,Cl_Uint8Type);
extern Cl_ReturnCodes cl_wait(Cl_Uint32Type ul_dly_ticks);
