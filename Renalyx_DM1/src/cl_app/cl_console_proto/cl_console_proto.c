...
Cl_ReturnCodeType cl_console_proto_init(void);
Cl_ReturnCodeType  Cl_Timer_Create_TimeoutEvent(void);
extern Cl_ReturnCodeType 	Cl_MacCheckforConsoleMessage(void);
//extern Cl_ReturnCodeType   Cl_SendDatatoconsoleDummycommand(Cl_ConsoleTxCommandtype,Cl_Uint8Type*,Cl_Uint8Type);
...
extern Cl_Uint8Type loopackflag ;
...
volatile Cl_BoolType g_b_led0_active = true;

#ifdef LED1_GPIO
/** LED1 blinking control. */
volatile Cl_BoolType g_b_led1_active = true;

#endif

#ifdef LED0_GPIO
volatile Cl_BoolType g_b_led2_active = true;
#endif
 ...
 */
Cl_Uint8Type temp=0,tempcount,tempcount1=0;
Cl_Uint32Type rxrdcounter=1;
volatile Cl_Uint8Type rxdata, copyrxdata ; //added
Cl_Uint8Type rxbuffer[10];
volatile Cl_Uint8Type rxbufferptr= 0;
volatile Cl_Uint8Type rxreadbuffptr = 0;
...
extern Cl_BoolType Cl_RinseOpenFillTimeOut;
...
static void ProcessButtonEvt(Cl_Uint8Type uc_button)
{
	if (uc_button == 0) {
 ...
 */
static void Button1_Handler(Cl_Uint32Type id, Cl_Uint32Type mask)
{
 ...
 */
static void Button2_Handler(Cl_Uint32Type id, Cl_Uint32Type mask)
{
...
void TC0_Handler(void)
{
	...
	volatile Cl_Uint32Type ul_dummy;
...
//void USART0_Handler(){
	...
	//Cl_Uint32Type received_byte;
	//Cl_Uint32Type dummy = usart_get_interrupt_mask(USART0);
...
{
	Cl_Uint32Type ul_div =0;
	Cl_Uint32Type ul_tcclks =0;
	Cl_Uint32Type ul_sysclk = sysclk_get_cpu_hz();
...
{
	Cl_Uint32Type ul_div;
	Cl_Uint32Type ul_tcclks;
	Cl_Uint32Type ul_sysclk = sysclk_get_cpu_hz();
...
Cl_BoolType  check_endofsequence_is_received(Cl_Uint8Type rdbufferindex )
{
	Cl_Uint8Type rdbufferptr ;
...
Cl_BoolType  check_startofsequence_is_received(Cl_Uint8Type rdbufferindex )
{
	Cl_Uint8Type rdbufferptr ;
	rdbufferptr =  rdbufferindex;
