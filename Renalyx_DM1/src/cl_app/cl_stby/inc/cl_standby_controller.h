...
typedef enum
{
	...
	EVENT_STBY_SET_BLDPMP_ON,
	EVENT_STBY_SET_BLDPMP_OFF,
	EVENT_STBY__SET_BP_RATE,
	EVENT_STBY_MAXEVENT
...
typedef struct
{
	...
	Cl_Uint8Type alarmseccount;
	Cl_Uint8Type alarmmincount;
	Cl_Uint8Type alarm5seccount;
