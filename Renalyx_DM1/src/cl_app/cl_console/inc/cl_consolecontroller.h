...
typedef enum {
			...
			CON_RX_COMMAND_HEP_PMP_RATE,//10
			...
			CON_RX_COMMAND_HEPARIN_BOLUS, //0x31 49
			CON_RX_COMMAND_HEPARIN_ON, //0x32 50
			CON_RX_COMMAND_HEPARIN_OFF, //0x33 51
			CON_RX_COMMAND_ISOUF_START, //0x34 52
			CON_RX_COMMAND_ISOUF_STOP, //0x35 53
...
typedef enum{
			...
			CON_TX_COMMAND_CL_SYS_STATE_DATA, //0x2A //42
			CON_TX_COMMAND_CL_SYS_STATE,//0x2B //43
			...
			CON_TX_COMMAND_COMMAND_HEATER_STATE, //0X44 68
			CON_TX_COMMAND_COMMAND_SYSTEM_STATE, //0X45 69
			CON_TX_COMMAND_COMMAND_SUBSYSTEM_STATE, //0X46 70
			CON_TX_COMMAND_COMMAND_SYSTEM_STATUS, //0x47 71
			CON_TX_COMMAND_COMMAND_ALARM_STATUS,//0x48 72
			CON_TX_COMMAND_COMMAND_BC_STATUS,//0x49 73
			CON_TX_COMMAND_COMMAND_ISOUF_COMPLETED, //74
			CON_TX_COMMAND_COMMAND_ISOUF_STARTED, //75
			CON_TX_COMMAND_COMMAND_ISOUF_STOPPED, //76
			CON_TX_COMMAND_COMMAND_ISOUF_PAUSED,
			CON_TX_COMMAND_COMMAND_ISOUF_RESUMED,
			CON_TX_COMMAND_ALERT,
			CON_TX_COMMAND_DISINF_STOPPED,
...
typedef enum {
	...
	CON_RX_PARAM_DATA_ISOUF_STATUS,
